...
// File: contracts/interfaces/ISwapCompany.sol

pragma solidity >=0.5.0;

interface ISwapCompany {
...
// File: contracts/SwapCompany.sol
...
contract SwapCompany is AdminRole, ISwapCompany {
    using EnumerableSet for EnumerableSet.AddressSet;
    /// @notice 当前工厂合约
    ...
    function createPair(address tokenA, address tokenB) external override returns (address pair) {
        ...
        require(pairForFactory[tokenA][tokenB] == address(0) || isAdmin(msg.sender), 'Swap: PAIR_EXISTS');
        // 调用工厂合约的创建配对方法
        pair = ISwapFactory(factory).createPair(tokenA, tokenB);
        // 记录token对应的工厂合约地址
